...
```text
亲爱的小伙伴们注意啦～
由于在开发过程中发现，各个OpenWrt衍生版本在数据返回和权限管理上各有各的小脾气，实在难以一碗水端平 😣，
所以我忍痛决定：后续版本将不再支持账号密码登录方式啦～
不过别担心！我们换上了更聪明、更统一的 CGI 脚本方式继续为大家服务 💪！
如果你还是超爱账号密码登录的“老味道”，可以去 Releases 里抱走第一个版本回家珍藏哦～
（悄悄说：那个版本以后就不更新啦，算是我们的“复古限定款”💕，且只支持iStoreOS系统）
一键安装命令已经准备好啦，快冲鸭！🚀
```
